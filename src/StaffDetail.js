...
class StallDetail extends React.Component {
    handleEdit(){
        let item = {};
    ...
    render () {
        ...
        return (
            <div className='overLay'>
                <h4 style={{'textAlign': 'center'}}>点击‘完成’保存修改，点击‘关闭’放弃未保存修改</h4>
                <hr/>
                <table ref='editTabel'>
                    <tbody>
                        <tr>
                            <th>姓名</th>
                            <td>
                                <input id='staffEditName' type='text' defaultValue={staffDetail.info.name} />
                            </td>
                        </tr>
                        <tr>
                            <th>年龄</th>
                            <td>
                                <input id='staffEditAge' type='text' defaultValue={staffDetail.info.age} />
                            </td>
                        </tr>
                        <tr>
                            <th>性别</th>
